...
static char *logcrash_api_argv[] = {
  XV6_TEST_PATH("xv6test"), "--logcrash-api", 0
};
static char *logcrash_before_prepare_argv[] = {
  XV6_TEST_PATH("xv6test"), "--logcrash-prepare", "before-commit", 0
};
static char *logcrash_before_verify_argv[] = {
  XV6_TEST_PATH("xv6test"), "--logcrash-verify", "before-commit", 0
};
static char *logcrash_after_prepare_argv[] = {
  XV6_TEST_PATH("xv6test"), "--logcrash-prepare", "after-commit", 0
};
static char *logcrash_after_verify_argv[] = {
  XV6_TEST_PATH("xv6test"), "--logcrash-verify", "after-commit", 0
};
static char *logcrash_install_prepare_argv[] = {
  XV6_TEST_PATH("xv6test"), "--logcrash-prepare", "during-install", 0
};
static char *logcrash_install_verify_argv[] = {
  XV6_TEST_PATH("xv6test"), "--logcrash-verify", "during-install", 0
};
